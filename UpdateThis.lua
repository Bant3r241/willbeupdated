-- AutoJoiner Pro v3.0
-- Features:
-- ✅ Supports ALL Job ID formats (UUID, Base64, Encoded)
-- ✅ Advanced BrainRot detection (5+ types)
-- ✅ WebSocket + HTTP fallback
-- ✅ Server history tracking
-- ✅ Rainbow UI with tab system
...
local HTTP_FALLBACK_URL = "https://your-http-fallback-api.com/servers"
